...
//	$time=$temp['time'];
	...
	// database에 ip_public, ip_virtual 갱신

	$query="update random_db 
			set ip_public='$ip_public', ip_virtual='$ip_virtual'
			where id='$id'";
	...
	if($k=='0'){
		...
		$response['message']='public ip, virtual ip 갱신 실패';
		exit;
	}

	$response['result']='true';
	$response['message']='public ip, virtual ip 갱신 성공';
